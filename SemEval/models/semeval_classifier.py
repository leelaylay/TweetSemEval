...
class SemEvalClassifier(Model):
    """
    This ``Model`` performs text classification for SemEval 2017 task 4 subset A.  We assume we're given a
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        super(SemEvalClassifier, self).__init__(vocab, regularizer)
